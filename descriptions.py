#Areas
woodlandDescription = "A dense, dark forest with huge gnarled trees\n"
...
lionDescription = "A huge, viscious lion with a golden mane and rows of razor sharp teeth"
trollDescription = "A giant, ugly, green beast with warts, carrying a wooden club"
goblinDescription = "A small green creature with pointy ears, carrying a small daggar"

#Structures
castleDescription = "A huge stone building with tall towers and a large moat"
campDescription = "A clearing in the woods where a camp is set up"
monasteryDescription = "A large cobbleMonasteryy, the sound of hyms coming from inside"
caveDescription = "There is a dark entrance to a cave, enshrouded in vines"
